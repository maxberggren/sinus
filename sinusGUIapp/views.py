...
def genShapefileImg(data, ranks, words, zoom, binThreshold, binModel, oneMap=False):
    ...
    for i, word in enumerate(words):
        ...
        legends.append(mpatches.Patch(color=cmap(0.75), label=word + " ({})".format(coord_count[word])) )
...
def byod():
    ...
    if excelfile:
        ...
        coordinatesByWord = newCoordinatesByWord
