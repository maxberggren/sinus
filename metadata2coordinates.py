        ...
        try:
            ...
            for row in result:
                ...
                if coordinate:
                    ...
                    print "update blogs set longitude = "+str(coordinate[1])+" and latitude = "+str(coordinate[0])+" WHERE city = '"+city+"' and municipality = '"+muni+"' and country='"+country+"' and county = '"+county+"'"
