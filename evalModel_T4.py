...
python evalModel_T4.py 2>&1 | tee -a T_Grammar_Centroid_1e40.log
python evalModel_T4.py 2>&1 | tee -a T_1Gaussians.log
"""
...
if __name__ == "__main__":
    ...
    for row in result:        
        ...
        if len(text) > 10000:
            ...
            data3 = predictViaAPI(text, path="tagbygrammar/threshold/1e0")
