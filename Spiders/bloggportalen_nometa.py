    ...
    try:
        ...
        if not ort:
            ...
            if not exists:
                ...
                if len(text) > 1000:
                    db['blogs'].insert(dict(url=link, presentation=presentation[2], ort=""))
...
if __name__ == '__main__':
    ...
    db = dataset.connect('sqlite:///bloggportalen_nometa.db')
    #db.begin()
    
    #scrapeWithTOR()

    #ids = xrange(43,151457) #  151457 är senaste
    ids = range(56, 151457) #  151457 är senaste 2 juli 2014
