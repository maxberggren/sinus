...
"""
with open("kommun_urls2.txt") as f:
    content = f.readlines()
    content = [line.replace('\n', '') for line in content]
"""

for url in ["https://blog.qruiser.com"]:
                                        ...
                                        if (page not in linkz):
                                            ...
                                            if (status != '200'):
                                                ...
                                                if (conTest == 0): # only doing pages, thank you very much
                                                    ...
                                                    """
                                                    html = urllib.urlopen("http://" + root + page).read()
                                                    
                                                    with open("/Users/max/Desktop/" +   root + ".txt", "a") as myfile:
                                                        myfile.write(nltk.clean_html(html))
                                                    """
                                                    print root + page
