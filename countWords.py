...
def count_words_in_region(region, bounding_box, percent=50):
    ...
    try:
        result = db.query("delete from tempwordcounts")
...
if __name__ == "__main__":
    ...
    # Genererade
    count_words_in_region('VaestraGoetaland', (12.125, 58.7666666667, 9.5, 57.7), percent=5)
    count_words_in_region('JoenkoepingGislavedsKommun', (14.75, 57.7, 12.125, 56.6333333333), percent=100)
    count_words_in_region('VaestraGoetalandFalkopingsKommun', (14.75, 58.7666666667, 12.125, 57.7), percent=100)
    count_words_in_region('VaermlandHammaroKommun', (14.75, 59.8333333333, 12.125, 58.7666666667), percent=100)
    count_words_in_region('VaermlandHagforsKommun', (14.75, 60.9, 12.125, 59.8333333333), percent=100)
    count_words_in_region('DalarnaAlvdalensKommun', (14.75, 61.9666666667, 12.125, 60.9), percent=100)
    count_words_in_region('JaemtlandArekommun', (14.75, 63.0333333333, 12.125, 61.9666666667), percent=100)
    count_words_in_region('BlekingeKarlskronaKommun', (17.375, 56.6333333333, 14.75, 55.5666666667), percent=100)
    count_words_in_region('KalmarHogsbyKommun', (17.375, 57.7, 14.75, 56.6333333333), percent=100)
    count_words_in_region('OEstergoetlandAtvidabergsKommun', (17.375, 58.7666666667, 14.75, 57.7), percent=100)
    count_words_in_region('VaestmanlandKungsoerskommun', (17.375, 59.8333333333, 14.75, 58.7666666667), percent=100)
    count_words_in_region('DalarnaHedemoraKommun', (17.375, 60.9, 14.75, 59.8333333333), percent=100)
    count_words_in_region('GaevleborgOvanakersKommun', (17.375, 61.9666666667, 14.75, 60.9), percent=100)
    count_words_in_region('VaesternorrlandAngeKommun', (17.375, 63.0333333333, 14.75, 61.9666666667), percent=100)
    count_words_in_region('JaemtlandRagundaKommun', (17.375, 64.1, 14.75, 63.0333333333), percent=100)
    count_words_in_region('VaesterbottenDoroteaKommun', (17.375, 65.1666666667, 14.75, 64.1), percent=100)
    count_words_in_region('VaesterbottenStorumansKommun', (17.375, 66.2333333333, 14.75, 65.1666666667), percent=100)
    count_words_in_region('StockholmVarmdoKommun', (20.0, 59.8333333333, 17.375, 58.7666666667), percent=100)
    count_words_in_region('UppsalaOsthammarsKommun', (20.0, 60.9, 17.375, 59.8333333333), percent=100)
    count_words_in_region('VaesternorrlandKramforsKommun', (20.0, 63.0333333333, 17.375, 61.9666666667), percent=100)
    count_words_in_region('VaesternorrlandOErnskoeldsviksKommun', (20.0, 64.1, 17.375, 63.0333333333), percent=100)
    count_words_in_region('VaesterbottenLyckselekommun', (20.0, 65.1666666667, 17.375, 64.1), percent=100)
    count_words_in_region('NorrbottenArvidsjaursKommun', (20.0, 66.2333333333, 17.375, 65.1666666667), percent=100)
    count_words_in_region('NorrbottenArjeplogsKommun', (20.0, 67.3, 17.375, 66.2333333333), percent=100)
    count_words_in_region('VaesterbottenSkellefteaKommun', (22.625, 65.1666666667, 20.0, 64.1), percent=100)
    count_words_in_region('NorrbottenAlvsbynsKommun', (22.625, 66.2333333333, 20.0, 65.1666666667), percent=100)
    count_words_in_region('NorrbottenGallivareKommun', (22.625, 67.3, 20.0, 66.2333333333), percent=100)
    count_words_in_region('NorrbottenHaparandaKommun', (25.25, 66.2333333333, 22.625, 65.1666666667), percent=100)
